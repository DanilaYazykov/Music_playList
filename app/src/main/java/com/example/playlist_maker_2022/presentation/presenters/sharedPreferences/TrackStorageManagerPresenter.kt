...
class TrackStorageManagerPresenter(val context: Context) {

    private val shared = TrackStorageManagerInteractor(sharedPreferencesManager = TrackStorageManagerImpl(context = context))
